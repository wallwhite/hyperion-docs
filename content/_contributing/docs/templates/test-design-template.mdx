---
title: Test Design Template
description: Template for documenting testing strategy alongside solution designs
icon: TestTube
---
...
Place test designs in: `content/{project}/docs/architecture/solution-designs/{number}/test-design.mdx`

Example: `content/billing-system/docs/architecture/solution-designs/001/test-design.mdx`
