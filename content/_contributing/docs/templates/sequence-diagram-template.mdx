...
description: Template for sequence diagrams showing component interactions over time
icon: GitGraph
---
...
<Diagram
  lang="plantuml"
  path="{project}/diagrams/seq/operation-name.puml"
  alt="Description"
/>
...
Place sequence diagrams in: `content/{project}/diagrams/seq/{client}/`

Example: `content/billing-system/diagrams/seq/admin-portal/deactivate-customer.puml`

## See Also

- [Diagram Guide](../guides/diagram-guide) for detailed standards
- [Solution Design Template](./solution-design-template) for including sequences in designs
